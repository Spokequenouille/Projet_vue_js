		...
		<div class="conteneur-pokemon">
			...
			<div class="type-pokemon">
				...
				<TypePokemon
					...
					v-bind:type_un="pokemon.type1"
					v-bind:type_deux="pokemon.type2"
				/>
			</div>
			...
			<div class="stat-pokemon" v-if="typeof pokemon.stats !== 'undefined'">
				<StatPokemon
					style="display:inline;"
					v-if="typeof pokemon.stats !== undefined"
					v-bind:attack="pokemon.stats[4].base_stat"
					v-bind:defense="pokemon.stats[3].base_stat"
					v-bind:attack_spe="pokemon.stats[2].base_stat"
					v-bind:defense_spe="pokemon.stats[1].base_stat"
					v-bind:hp="pokemon.stats[5].base_stat"
					v-bind:vitesse="pokemon.stats[0].base_stat"
				/>
			</div>
		</div>
	</div>
